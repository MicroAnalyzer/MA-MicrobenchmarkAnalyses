...
import joelbits.modules.analysis.plugins.visitors.ConstantFoldingSourceCodeVisitor;
...
public final class ConstantFoldingSourceCodeMapper extends Mapper<Text, BytesWritable, Text, Text> {
    ...
    public void map(Text key, BytesWritable value, Context context) throws IOException, InterruptedException {
        ...
        ConstantFoldingSourceCodeVisitor visitor = new ConstantFoldingSourceCodeVisitor();
