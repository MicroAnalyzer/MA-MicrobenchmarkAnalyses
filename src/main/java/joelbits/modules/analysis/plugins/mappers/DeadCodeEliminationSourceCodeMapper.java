...
public final class DeadCodeEliminationSourceCodeMapper extends Mapper<Text, BytesWritable, Text, Text> {
    ...
    public void map(Text key, BytesWritable value, Context context) throws IOException, InterruptedException {
        ...
        DeadCodeEliminationSourceCodeVisitor visitor = new DeadCodeEliminationSourceCodeVisitor();
